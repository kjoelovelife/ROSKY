...
from rosky_msgs.cfg import Lane_Controller_ParamConfig
...
class LANE_CONTROLLER_RECONFIGURE(object):
    def __init__(self):
        ...
        # start rqt_reconfig
        self.reconfigure = Server(Lane_Controller_ParamConfig, self.rqt_callback)
    ...
    def getFilePath(self, name):
        ...
        return rospack.get_path('rosky_base')+'/config/baseline/lane_control/lane_controller_node/' + name + ".yaml"  
...
if __name__ == "__main__":
    ...
    lane_controller_reconfigure_node = LANE_CONTROLLER_RECONFIGURE()
    rospy.on_shutdown(lane_controller_reconfigure_node.on_shutdown)
    rospy.spin()
