...
from rosky_msgs.msg import SegmentList, Segment, Pixel, LanePose, BoolStamped, Twist2DStamped
...
For more info on algorithm and parameters please refer to the google doc:
 https://drive.google.com/open?id=0B49dGT7ubfmSX1k5ZVN1dEU4M2M
    ...
    def __init__(self):
        ...
        self.sub_freq = rospy.get_param( "/" + self.veh_name + "/cam_info_reader_node/pub_freq",1)
