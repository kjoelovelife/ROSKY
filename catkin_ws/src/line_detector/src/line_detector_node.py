...
from rosky_msgs.msg import (AntiInstagramTransform, BoolStamped, Segment,
    SegmentList, Vector2D)
from rosky_utils.instantiate_utils import instantiate
from rosky_utils.jpg import image_cv_from_jpg
...
class LineDetectorNode(object):
    ...
    def updateParams(self, _event):
        temp_c = rospy.get_param('~detector')
